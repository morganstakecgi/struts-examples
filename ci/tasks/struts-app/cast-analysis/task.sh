...
mkdir -p $WORK_DIR
cd struts-examples
java -jar ${CAST_AGENT_JAR} --analyzerDir  ${CAST_AGENT_PERL} --workingDir ${WORK_DIR} --sourceDir .  --login <cast Login> --password "*****" --applicationId <get this from your admin> --companyId <get this from your admin> --serverUrl "https://rpa.casthighlight.com"
