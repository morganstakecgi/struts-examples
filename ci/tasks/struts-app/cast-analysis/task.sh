...
mkdir -p $WORK_DIR
cd struts-examples
java -jar ${CAST_AGENT_JAR} --analyzerDir  ${CAST_AGENT_PERL} --workingDir ${WORK_DIR} --sourceDir .  --login morgan.stake@cgi.com --password "G33kzilla" --applicationId 16589 --companyId 2139 --serverUrl "https://rpa.casthighlight.com"
